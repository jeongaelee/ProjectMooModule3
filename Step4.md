...
2. Design 탭의 Inbound Policy에 아래의 값을 복사하여 붙여 넣습니다. "work-type"이라는 Header 값이 "work"일때는 openai-instance2를 디폴트로는 openai-instance1을 Backend로 설정하는 규칙입니다.
    ...
    <policies>
        <inbound>
            ...
            <set-backend-service backend-id="@{
                ...
                switch(context.Request.Headers.GetValueOrDefault("work-type", "work")) {
                    case "work":
                        return "openai-instance2";

                    default:
                        return "openai-instance1";
                }
            }" />
